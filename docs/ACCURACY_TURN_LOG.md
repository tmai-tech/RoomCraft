...
| D Accuracy resume | 55+ / +105+ | Geometry, non-study, openings, AR scale lock, Phase B metrics |
...
| Planner5D behavior | RoomCraft now (+108) | Gap |
|--------------------|----------------------|-----|
...
| Honest confidence | Geometry + openings + scale source floors | Phase B metrics exist; not yet in UI export |
