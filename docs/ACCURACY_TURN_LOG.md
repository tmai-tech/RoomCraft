...
| D Accuracy resume | 55+ / +105+ | Geometry → openings → AR scale → Phase B export/UI |
...
| Planner5D behavior | RoomCraft now (+109) | Gap |
|--------------------|----------------------|-----|
...
| Honest confidence | Geometry + openings + scale floors + Phase B in Review/export | User-corrected gold reference still open |
