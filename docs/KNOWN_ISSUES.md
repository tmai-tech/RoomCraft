...
Last updated: 2026-08-12 · Version **1.0.0-beta.1+145**

## Expected limitations

| Issue | Impact | Workaround |
|-------|--------|------------|
| **Gallery photos ≠ metric 100%** | Monocular AI cannot measure real feet like LiDAR | Use **Home → Scan the room** (AR walk) + optional **one-wall tape** (+145) |
...
| Photo/AI wall scan is **assistive only** | Doors/furniture often wrong without tape | Prefer AR + inventory chips; edit openings on blueprint |
| Furniture still empty after AR size-only | AR locks metric size first (Planner5D-class) | Mark contents after size confirm (doors / desk / table…) |
...
**Field retest:** [PHASE0_RETEST_CHECKLIST.md](PHASE0_RETEST_CHECKLIST.md) · **Build phases:** [SCAN_ACCURACY_BUILD_PHASES.md](SCAN_ACCURACY_BUILD_PHASES.md)
