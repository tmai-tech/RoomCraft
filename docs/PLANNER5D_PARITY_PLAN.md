...
**Next free sprint order:** (1–10)✅+95–103 (11)~~notes + feature graphic~~✅+104 (12) Play Console closed track upload (ops).
...
| Item | Status |
|------|--------|
| L-shape / polygon floor outline | ✅ RoomGeometry + RoomModel.floorPolygonFt |
| Blueprint + 3D floor draw L; room size L-shape action | ✅ |
| Gallery L-shape living plan | ✅ `l_living` |
| Photoreal mesh / brand / multi-floor | ❌ still open |

### +98
| Item | Status |
|------|--------|
| Polygon-aware furniture clamp (no cutout rest) | ✅ |
| Clearances tip for furniture outside L floor | ✅ |
| PDF shape line + export heatmap option | ✅ |
...
| Item | Status |
|------|--------|
| Home AR/Scan/Draw/Gallery pillars | ✅ |
...
| Item | Status |
|------|--------|
| Room notes + smart home search | ✅ |
| Feature graphic 1024×500 export | ✅ free Play asset |
| PDF notes line | ✅ |
| Photoreal / brand / Play Console upload | ❌ ops |
